...
"""PyInstaller spec for OpenVoice Desktop (onedir portable bundle).

Build (from repo root):
    python -m PyInstaller --noconfirm --clean packaging/OpenVoiceDesktop.spec
